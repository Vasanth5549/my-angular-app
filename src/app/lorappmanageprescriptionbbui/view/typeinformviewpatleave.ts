...
import { Level, ProfileContext, OnProfileResult, IProfileProp,Byte, Decimal, decimal, Double, Float, Int64, long, Long, StringComparison,AppDialogEventargs, AppDialogResult, DelegateArgs, DialogComponentArgs, WindowButtonType, ContentControl, KeyEventArgs, SelectionChangedEventArgs } from 'epma-platform/models';
import { AppDialog, Border, EventArgs, MouseButtonEventArgs, ScrollViewer, ToolTipService, UserControl, iButton, iCheckBox, iComboBox, iDateTimePicker, iHyperlinkButton, iLabel, iTextBox, iTimeBox, iUpDownBox } from 'epma-platform/controls';
...
var that;
@Component({
    selector: 'TypeinFormViewLeave',
    templateUrl: './typeinformviewpatleave.html',
    styleUrls: ['./typeinformviewpatleave.css'],
  })


export class TypeinFormViewLeave extends UserControl implements AfterViewInit {
...
@ViewChild("MedIPResolveSteppedTempRef", {read:medipresolvestepped, static: false }) set _MedIPResolveStepped(c: medipresolvestepped){
    ...
    cboFrequency_LostFocus(sender: Object, e: RoutedEventArgs): void {
