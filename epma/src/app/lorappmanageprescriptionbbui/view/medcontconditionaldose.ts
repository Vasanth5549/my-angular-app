...
@Component({
    selector: 'medContConditionalDose',
    templateUrl: './medcontconditionaldose.html',
    styleUrls: ['./medcontconditionaldose.css']
})
export class medContConditionalDose extends UserControl {
    ...
    @Input() medContConditionalDoseLoadedFunc: Function;
    ...
    private SelectObservationResult(ObservationResult: CTreeListItem): void {
        ...
        let _ErrorSource: string = "LorAppManagePrescriptionBBUI_P2.dll, Class:medContConditionalDose, Method:SelectObservationResult()";
        if (this.tvwCondition && this.tvwCondition.TreeViewDataContext) {
