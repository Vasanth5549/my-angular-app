...
import {  ObservableCollection,ArrayOfString } from "epma-platform/models";
    ...
    export class DrugPropertynew{
        DrugPropertyCode:number = 0;
        DrugName:string = "";
      }
    ...
    {
        private LinksField:Array<LinkInformation>;
        
        public get Links():Array<LinkInformation>{
            return this.LinksField;
        }

        public set Links(value: Array<LinkInformation>){  
    ...
    {
        public PowerSearchCategoriesField = '';

        public EncounPresConfigField: Array<EncounterPresConfigurations> = new Array<EncounterPresConfigurations>() ;
